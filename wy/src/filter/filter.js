/**
 * 数组过滤器 例如：{{VIDEO_CHARGE | optionKV(video.charge)}}
 * @param object 例如：{CHARGE:{key:1, value:"收费"},FREE:{key:0, value:"免费"}}
 * @param key 例如：C
 ...
 * @returns {string} 例如：收费
 */
let optionKVArray = (list, key) =>  {// eslint-disable-line no-unused-vars
    if (!list || !key) {
        return "";
    } else {
        let result = "";
